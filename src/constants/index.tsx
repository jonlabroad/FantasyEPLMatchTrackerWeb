...
export type API_REQUEST_IN_PROGRESS = typeof API_REQUEST_IN_PROGRESS;
...
export const DRAWER_OPEN_CLOSE = 'DRAWER_OPEN_CLOSE';
export type DRAWER_OPEN_CLOSE = typeof DRAWER_OPEN_CLOSE;
...
export const RECEIVE_ENTRY_HISTORY = 'RECEIVE_ENTRY_HISTORY';
export type RECEIVE_ENTRY_HISTORY = typeof RECEIVE_ENTRY_HISTORY;

export const RECEIVE_GAMEWEEK_TIMELINE = 'RECEIVE_GAMEWEEK_TIMELINE';
export type RECEIVE_GAMEWEEK_TIMELINE = typeof RECEIVE_GAMEWEEK_TIMELINE;
